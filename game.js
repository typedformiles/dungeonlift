...
const QUIZ_QUESTIONS = [
    { q: 'What is the biggest limitation of rules-based segmentation?', answers: ['It only finds what you already expect to find', 'It costs too much to run at enterprise scale', 'It takes too long to execute on large datasets', 'It requires too much storage and compute power'], correct: 0 },
    { q: 'What does "human bias" in segmentation mean?', answers: ['Analysts only test hypotheses they already believe', 'Humans type too slowly to process real-time data', 'Manual processes consume too much compute memory', 'Teams forget to save their queries and lose work'], correct: 0 },
    { q: 'Why is demographic data alone a poor predictor of purchase behaviour?', answers: ['Demographics are too expensive to collect reliably at scale', 'People with identical demographics often have very different preferences and buying patterns', 'It only works for B2B companies selling to other businesses', 'Collecting demographic data always violates GDPR regulations'], correct: 1 },
    { q: 'What is "Lift Potential"?', answers: ['A measure of how much data your warehouse can handle', 'The quantifiable value of moving a specific customer to a higher-value state before they churn or plateau', 'A SQL function used to rank customers by revenue', 'The percentage of server uptime during peak hours'], correct: 1 },
    { q: 'Why do data silos hurt segmentation?', answers: ['They consume too much electricity across multiple servers', 'They prevent seeing the full customer picture across touchpoints', 'They make dashboards harder to design and maintain', 'They slow down email sends and campaign deployment'], correct: 1 },
    { q: 'What is a "lookalike audience" based on?', answers: ['People who look physically similar to existing customers', 'A seed set of high-quality first-party data, used to find similar users at scale', 'Accounts that share the same login credentials or passwords', 'Customers who happen to be in the same geographic timezone'], correct: 1 },
    ...
    { q: 'Why is sampling problematic for segmentation?', answers: ['It can miss small but valuable micro-segments entirely', 'It makes charts and visualisations look inaccurate', 'Modern databases cannot process sampled data reliably', 'It always violates GDPR data processing regulations'], correct: 0 },
    { q: 'What is "churn" in a customer context?', answers: ['A method for backing up database records periodically', 'When customers stop engaging with or buying from a brand', 'A type of data visualisation used in retention reporting', 'A metric for measuring server processing throughput'], correct: 1 },
    { q: 'What advantage does AI segmentation have over SQL queries?', answers: ['It runs on significantly cheaper commodity hardware', 'It discovers patterns humans wouldn\'t think to test', 'It needs far less data to produce reliable segments', 'It doesn\'t require any database connection at all'], correct: 1 },
    { q: 'What is Customer Lifetime Value (CLV/LTV)?', answers: ['A measure of how long a customer has been active', 'The total revenue generated from a customer over the entire relationship', 'The age of a customer record in the database system', 'The average duration of a single browsing session'], correct: 1 },
    { q: 'What does "explainable AI" mean for marketing teams?', answers: ['AI that can auto-generate technical documentation', 'AI outputs that come with clear reasoning, not just numbers', 'AI that explains its logic to regulators and auditors only', 'A conversational chatbot for handling customer service'], correct: 1 },
    { q: 'Why are boolean filters limiting for segmentation?', answers: ['They frequently crash the database under heavy load', 'They force binary yes/no splits, missing nuance', 'Boolean logic has been formally deprecated in modern SQL', 'They only function correctly inside Excel spreadsheets'], correct: 1 },
    { q: 'What is "bottom-up segmentation"?', answers: ['Building segments by aggregating the smallest data points upward', 'Manually cutting data at the divisional or single-tool level, based on predefined criteria', 'Letting junior analysts define the initial segments first', 'Starting with individual customer records and clustering them together'], correct: 1 },
    { q: 'Why is feature engineering important in segmentation?', answers: ['It makes the user interface look better for analysts', 'It transforms raw, noisy data into informative inputs, significantly boosting AI model accuracy', 'It reduces overall server and infrastructure running costs', 'It encrypts sensitive customer data before model training'], correct: 1 },
    { q: 'What is a "persona" in marketing?', answers: ['A fictional user account created for QA and testing purposes', 'A qualitative archetype representing a customer segment, used to guide messaging and strategy', 'A unique username assigned to users on social media platforms', 'An executive sponsor who signs off on campaign budgets'], correct: 1 },
    ...
    { q: 'Which data type would a traditional segmentation model likely miss?', answers: ['Standard age bracket and demographic groupings', 'Unexpected cross-domain behavioural correlations', 'Basic gender classification from profile records', 'Email address formatting and domain analysis'], correct: 1 },
    { q: 'What is the risk of relying on demographic segmentation alone?', answers: ['It exposes the company to intellectual property violations', 'It assumes behaviour follows demographics, which it often doesn\'t', 'Demographics are becoming too expensive to collect at scale', 'It only produces reliable results for B2B sales teams'], correct: 1 },
    { q: 'Why is Neuralift\'s consumption-based pricing model better for customers?', answers: ['It\'s positioned as the cheapest option on the market today', 'It doesn\'t lock you in, and provides total usage flexibility', 'It charges a simple flat fee based on the number of user seats', 'It requires a standard 3-year minimum enterprise contract'], correct: 1 },
    { q: 'What AI technology underpins Neuralift\'s unsupervised learning approach?', answers: ['Large language models trained on marketing data', 'Deep learning neural network', 'Decision trees and random forest ensembles', 'Reinforcement learning with reward-based agents'], correct: 1 },
    { q: 'Why could Neuralift be thought of as a "context engine" rather than just a segmentation tool?', answers: ['It connects to significantly more data sources than competitors', 'It creates a rich per-segment narrative layer alongside the math', 'It fully replaces your existing data warehouse infrastructure', 'It is designed to only work with contextual advertising data'], correct: 1 },
    { q: 'What problem does Neuralift solve for data science teams specifically?', answers: ['It completely replaces the need for data scientists on staff', 'It automates deep segmentation that otherwise takes weeks or months', 'It automatically writes and optimises SQL queries for analysts', 'It manages their entire cloud infrastructure and deployment'], correct: 1 },
    { q: 'What is the typical starting point for a Neuralift engagement?', answers: ['A 12-month enterprise licence with annual renewal terms', 'A single-use-case pilot with no long-term commitment', 'A full data warehouse migration to the Neuralift platform', 'A six-month proof of concept requiring dedicated engineers'], correct: 1 },
    { q: 'What does Neuralift\'s Reasoning module do?', answers: ['It handles the core neural network training and GPU compute', 'Uses frontier LLMs to create narratives, insights, strategies and personas from the neural output', 'It manages user permissions, roles and access control policies', 'It optimises SQL query performance across connected databases'], correct: 1 },
    { q: 'How much incremental revenue did Neuralift\'s launch customer generate through deep learning segmentation?', answers: ['Around $100 in the first test campaign', 'Approximately $10,000 across their initial pilot', 'Close to $100,000 over the first quarter of usage', 'Over $10,000,000 in measurable incremental revenue'], correct: 3 },
];
