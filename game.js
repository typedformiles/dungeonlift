...
const QUIZ_QUESTIONS = [
    ...
    { q: 'What is Customer Lifetime Value (CLV/LTV)?', answers: ['A measure of how long a customer has been active', 'Predicted total revenue from a customer relationship', 'The age of a customer record in the database system', 'The average duration of a single browsing session'], correct: 1 },
